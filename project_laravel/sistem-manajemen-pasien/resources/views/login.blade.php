        ...
        <div class="bg-white rounded-3xl shadow-xl w-full max-w-md p-8">
            ...
            <div class="text-center mb-8">
                ...
                <h1 class="text-2xl font-extrabold text-gray-900">
                    ...
                    Masuk ke Sistem Administrasi Pasien
            ...
            <form method="POST" action="/login" novalidate>
                ...
                <div class="mb-5">
                    ...
                    <div class="relative">
                        ...
                        <input type="password" id="pwd" name="password" placeholder="Password Anda" required
                            class="w-full pl-9 pr-10 py-2.5 border border-gray-200 rounded-xl text-sm focus:outline-none focus:ring-2 focus:ring-blue-400">
                ...
                <button type="submit"
                    class="w-full bg-blue-500 hover:bg-blue-600 text-white py-3 rounded-xl font-bold text-sm transition shadow-lg shadow-blue-200">
            ...
            <div class="mt-5 bg-blue-50 rounded-xl p-3 text-xs text-gray-500">
                ...
                admin@klinikgenz.com / Admin@123
